    ...
    value: function serialize() {
      ...
      if (isEmpty(this.value())) {
        ...
        return this.value().map(function (t) {
          ...
          } else if (isFunction_default()(t.serialize)) {
            return t.serialize();
  ...
  transformation_createClass(Transformation, [{
    ...
    */
    ...
    value: function offset(value) {
      ...
      var _ref = isFunction_default()(value != null ? value.split : void 0) ? value.split('..') : isArray_default()(value) ? value : [null, null];
...
function urlString(publicId, options) {
  ...
  return compact_default()([prefix, resourceType, signature, transformationString, version, publicId]).join('/').replace(/([^:])\/+/g, '$1/');
}
/**
